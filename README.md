...
1. Jones, R., Hosking, A., & Moss, E. (2011). *The Garbage Collection Handbook: The Art of Automatic Memory Management*.
2. Boehm, H., & Weiser, M. (1988). *Garbage Collection in an Uncooperative Environment*. *Software: Practice and Experience*.
